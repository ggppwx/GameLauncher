        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="btn-steam px-4 py-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={importing}
              title={importing ? 'Importing...' : 'Import Steam'}
            >
              {importing ? 'Importing…' : 'Import Steam'}
            </button>
            <button
